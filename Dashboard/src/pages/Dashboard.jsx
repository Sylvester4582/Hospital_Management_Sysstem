...
const Dashboard = () => {
  const { isAuthenticated, user, doctors, setDoctors } = useContext(Context);
        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit perferendis quisquam quia laborum numquam nemo?</p>
            </div>
          </div>
